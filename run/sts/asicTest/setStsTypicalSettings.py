...
ana_glob_05 =  12 # Shaping time constant for slow shaper <3:2> 0-90ns, 1-160ns, Channel selection <1:0> 0-0,4,...124 + 129, 3-3,7,....127 +128. For ampCal, channel selection is not showing any affect.
ana_glob_06 =  32 # Reference current for the high speed discriminator Typical value 32 for 53uA
ana_glob_07 =  32 # High speed discriminator threshold Typical value 100
ana_glob_08 =  44 # ADC low threshold <5:0> and DAC ADC_VREF_N for bit 6 Typical value 31
ana_glob_09 =  58 # 54 ADC high threshold
ana_glob_10 =  57 # 58 DAC ADC_VREF_T bit 6, Global ADC threshold (VREF_T) <5:0> and <8>: enable Typical value 188
