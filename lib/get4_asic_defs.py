...
#
GET4V1X_INIT_RO_INIT         = 0x00000000
...
#
GET4V1X_INIT_RO_RST          = 0x01000000
...
# clock cycles (1.024 us).
#
GET4V1X_INIT_RODLL_RST       = 0x07000000
...
# clock signal.
#
GET4V1X_INIT_DLL_RST_PH      = 0x05000000
...
#
GET4V1X_INIT_DLL_RST_AUTO    = 0x06000000
...
#
GET4V1X_EP_SYNC_INIT         = 0x08000000
...
#
GET4V1X_EP_SYNC_RST          = 0x09000000
...
#
GET4V1X_DIAG_SELECT          = 0x10000000
...
#
GET4V1X_RO_CONF_BASIC        = 0x20000000
...
# cf GET4 > v1.20 manuals
#
GET4V1X_RO_CONF_BIT_ERR_TEST = 0x21000000
...
#
GET4V1X_24B_RO_CONF          = 0x28000000
...
# cf GET4 > v1.20 manuals
#
GET4V1X_32B_RO_CONF_TOT      = 0x30000000

#
# Sub address 001 - Time over Threshold Range => 0011 0001
# cf GET4 > v1.20 manuals
#
GET4V1X_32B_RO_CONF_TOT_MAX  = 0x31000000
...
# cf GET4 > v1.20 manuals
#
GET4V1X_32B_RO_CONF_LNK_RATE = 0x32000000
...
#
GET4V1X_TEST_PATT_GEN_CH0    = 0x38000000
GET4V1X_TEST_PATT_GEN_CH0    = 0x39000000
GET4V1X_TEST_PATT_GEN_CH0    = 0x3A000000
GET4V1X_TEST_PATT_GEN_CH0    = 0x3B000000

#
# Sub address 100 - Counter Configuration => 0011 1100
# cf GET4 > v1.20 manuals
#
GET4V1X_TEST_PATT_GEN_CONF   = 0x3C000000

#
# Sub address 101 - Stop Pattern Generator => 0011 1101
#
#GET4V1X_TEST_PATT_GEN_ STOP  = 0x3D000000

#
# Sub address 111 - Oscillator Frequency => 0011 1111
# cf GET4 > v1.20 manuals
#
GET4V1X_TEST_PATT_GEN_OSC_FQ = 0x3F000000
...
#
GET4V1X_SPI_CONF             = 0x40000000

#
# Sub address 001 - SPI start => 0100 0001
#
GET4V1X_SPI_START            = 0x41000000

#
# Sub address 010 - SPI stop => 0100 0010
#
GET4V1X_SPI_STOP             = 0x42000000

#
# Sub address 011 - SPI data => 0100 0011
#
GET4V1X_SPI_DATA             = 0x43000000
